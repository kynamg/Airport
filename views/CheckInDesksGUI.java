...
public class CheckInDesksGUI extends JPanel implements Observer{
	...
	public synchronized void update() {
	   switch(checkindata.get_desk_no()) {
			case 1:  desk1_label.setText(checkindata.get_check_in_info());
	                 break;
			case 2:  desk2_label.setText(checkindata.get_check_in_info());
	        			break;
			case 3:  desk3_label.setText(checkindata.get_check_in_info());
	        			break;
			case 4:  desk4_label.setText(checkindata.get_check_in_info());
	        			break;
			case 5:  desk5_label.setText(checkindata.get_check_in_info());
	        			break;
	        default: break;
		}
}

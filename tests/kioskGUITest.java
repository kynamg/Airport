...
class kioskGUITest {
	...
	void test_volume_calculation() {
		...
		volume_entry.setText("1");
		returned_1 = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		...
		volume_entry.setText("!");
		returned_exclimation = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		...
		volume_entry.setText("");
		returned_empty = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		...
		volume_entry.setText("2.2");
		returned_2_2 = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		...
		volume_entry.setText("2.8");
		returned_2_8 = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		...
		volume_entry.setText("2.8.8");
		returned_2_8_8 = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		...
		volume_entry.setText("-1");
		returned_negative = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		...
		volume_entry.setText("0");
		returned_0 = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		...
		volume_units.removeItem("cm\u00B3");
		
		Object[] returned_1_inches = new Object[2];
		volume_entry.setText("1");
		returned_1_inches = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		boolean expected_bool_1_inches = true;
		int expected_weight_1_inches = 16;
		String message_1_inches = "Failed at 1 inches";
		assertEquals(message_1_inches, expected_bool_1_inches, returned_1_inches[0]);
		assertEquals(message_1_inches, expected_weight_1_inches, returned_1_inches[1]);
		
		Object[] returned_2_2_inches = new Object[2];
		volume_entry.setText("2.2");
		returned_2_2_inches = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		boolean expected_bool_2_2_inches = true;
		int expected_weight_2_2_inches = 36;
		String message_2_2_inches = "Failed at 2.2 inches";
		assertEquals(message_2_2_inches, expected_bool_2_2_inches, returned_2_2_inches[0]);
		assertEquals(message_2_2_inches, expected_weight_2_2_inches, returned_2_2_inches[1]);
		
		Object[] returned_10_8_inches = new Object[2];
		volume_entry.setText("10.8");
		returned_10_8_inches = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		boolean expected_bool_10_8_inches = true;
		int expected_weight_10_8_inches = 117;
		String message_10_8_inches = "Failed at 2.2 lbs";
		assertEquals(message_10_8_inches, expected_bool_10_8_inches, returned_10_8_inches[0]);
		assertEquals(message_10_8_inches, expected_weight_10_8_inches, returned_10_8_inches[1]);
		
		Object[] returned_0_inches = new Object[2];
		volume_entry.setText("0");
		returned_0_inches = gui_test.calculate_volume(dimension_entry, dimension_units, volume_entry, volume_units);
		boolean expected_bool_0_inches = true;
		String message_0_inches = "Failed at zero_lbs";
		assertEquals(message_0_inches, expected_bool_0_inches, returned_0_inches[0]);
		assertEquals(message_0_inches, 0, returned_0_inches[1]);
	}*/
